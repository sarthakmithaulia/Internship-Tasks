...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/beeple">Tokens (4)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div>Originator&nbsp;of the current "everyday" movement in 3D graphics, <strong><a href="https://www.beeple-collect.com/">Beeple</a>&nbsp;</strong>has been creating a picture and posting it online for over <strong>thirteen years</strong> without missing a single day.</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0xc6b0562605d35ee710138402b878ffe6f2e23807" data-bs-toggle="tooltip" data-bs-title="0xc6b0562605d35ee710138402b878ffe6f2e23807"><span data-highlight-target="0xc6b0562605D35eE710138402B878ffe6F2E23807">0xc6b056...F2E23807</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xc6b0562605D35eE710138402B878ffe6F2E23807" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xc6b_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xc6b_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Beeple</td><td>42<b>.</b>75251889 ETH</td><td>598</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 1 Account</th><th class="border-top border-bottom-0">42.75251889 Ether</th><th class="border-top border-bottom-0">598</th></tr></tfoot></table></div></div></div>

<form method="post" action="./beeple" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="lmHX/GfVq6ZjCj4NsLfiGHMKj0MFAo2qKkm80D7Dt+zj4qWfdQIBXURfPfv3EYp+qt6zONxKdZyo9J7PdM8Z6PsDK2EH+reYUYMmbT4L+e8=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="beeple">
<script>
        var mydt = []
