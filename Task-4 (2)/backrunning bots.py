...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,288.62</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-1.08%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 13 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">13</span> Gwei</a></span></div>
</div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xf443253607dbde5bda77c358c9b9f244d819e25c" data-bs-toggle="tooltip" data-bs-title="0xf443253607dbde5bda77c358c9b9f244d819e25c"><span data-highlight-target="0xf443253607Dbde5bdA77C358c9b9f244D819E25C">0xf44325...D819E25C</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xf443253607Dbde5bdA77C358c9b9f244D819E25C" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xf44_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xf44_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td></td><td>0 ETH</td><td>559,396</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x78a55b9b3bbeffb36a43d9905f654d2769dc55e8" data-bs-toggle="tooltip" data-bs-title="0x78a55b9b3bbeffb36a43d9905f654d2769dc55e8"><span data-highlight-target="0x78A55B9b3BBEffB36A43D9905F654d2769dC55e8">0x78A55B...69dC55e8</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x78A55B9b3BBEffB36A43D9905F654d2769dC55e8" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x78a_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x78a_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td></td><td>0 ETH</td><td>1,243,276</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">0 Ether</th><th class="border-top border-bottom-0">1,802,672</th></tr></tfoot></table></div></div></div>

<form method="post" action="./backrunning-bots" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="T5fshBT4TyedZGuBax5s5oAov6Nlz0eZd0/8JxhizK+iDKsFvRlpmAJmZDN88eDeIjTjmGjKv1SKn0XKlg1AZ8LF+E4ATOi64LEKan+myz4=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="backrunning-bots">
<script>
        var mydt = []
...
output_file_path = 'Backrunning Bots.json'
