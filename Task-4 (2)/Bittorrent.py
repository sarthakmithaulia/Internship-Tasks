...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,301.01</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-0.52%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 14 Gwei<br>Priority Fee: 1 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">15</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/bittorrent">Tokens (2)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div>BitTorrent, Inc. is a consumer software company based in San Francisco. Its protocol is a decentralized P2P network in the world that is driving 22% of upstream and 3% of downstream traffic globally.<br>
&nbsp;</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xe83cccfabd4ed148903bf36d4283ee7c8b3494d1" data-bs-toggle="tooltip" data-bs-title="0xe83cccfabd4ed148903bf36d4283ee7c8b3494d1"><span data-highlight-target="0xE83CCCfABD4eD148903Bf36d4283eE7C8b3494D1">0xE83CCC...8b3494D1</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xE83CCCfABD4eD148903Bf36d4283eE7C8b3494D1" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xe83_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xe83_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>BitTorrent Chain: Old BTT Token</td><td>0 ETH</td><td>325</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0x3d0962d31d8a3171564b8d2e4d84c97148cb0bd2" data-bs-toggle="tooltip" data-bs-title="0x3d0962d31d8a3171564b8d2e4d84c97148cb0bd2"><span data-highlight-target="0x3D0962D31D8A3171564b8D2e4d84C97148cb0BD2">0x3D0962...48cb0BD2</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x3D0962D31D8A3171564b8D2e4d84C97148cb0BD2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x3d0_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x3d0_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td>TRON: Deployer</td><td>0<b>.</b>04980844 ETH</td><td>22</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">0.04980844 Ether</th><th class="border-top border-bottom-0">347</th></tr></tfoot></table></div></div></div>

<form method="post" action="./bittorrent" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="ZWWqHbNXtOwlSaYyR99+5IfDnNElKXWq3lZ8FH5tMKN0Mb3Dw25SPQfvlw3fk+8u2F8jBktgunszm6pVPLQs5ccjpx9l0DjTeOVmNVm1SY0=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="bittorrent">
<script>
        var mydt = []
...
output_file_path = 'BitTorrent.json'
