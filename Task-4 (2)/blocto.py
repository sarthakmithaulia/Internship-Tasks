...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,298.45</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-0.63%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 12 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">12</span> Gwei</a></span></div>
</div>
...
<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://www.blocto.io/">Blocto</a> is building a cross-blockchain ecosystem with blockchain applications(dApps), crypto, and NFT assets and developers can integrate with the identity and payment services.</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xf7ccfaee69cd8a0b3a62c2a0f35f95cc7e588183" data-bs-toggle="tooltip" data-bs-title="0xf7ccfaee69cd8a0b3a62c2a0f35f95cc7e588183"><span data-highlight-target="0xF7cCFaee69cD8A0B3a62C2A0f35F95cC7e588183">0xF7cCFa...7e588183</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xF7cCFaee69cD8A0B3a62C2A0f35F95cC7e588183" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xf7c_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xf7c_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Blocto: ERC-4337 Factory 1</td><td>0 ETH</td><td>370</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xa312d8d37be746bd09cbd9e9ba2ef16bc7da48ff" data-bs-toggle="tooltip" data-bs-title="0xa312d8d37be746bd09cbd9e9ba2ef16bc7da48ff"><span data-highlight-target="0xa312d8D37Be746BD09cBD9e9ba2ef16bc7Da48FF">0xa312d8...c7Da48FF</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xa312d8D37Be746BD09cBD9e9ba2ef16bc7Da48FF" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xa31_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xa31_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Blocto: ERC-4337 Paymaster 1</td><td>0 ETH</td><td>2</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">0 Ether</th><th class="border-top border-bottom-0">372</th></tr></tfoot></table></div></div></div>

<form method="post" action="./blocto" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="OU/GYL4CTa9ETadB1T7/HiRxbgEAYQrCU1N76B2VxCScaLaBAi8JdWp32Z7Eyq8It4FhiFwcInUUdbMfsoh+A6gXMDMJPuQwLjqPvCqxIL4=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="blocto">
<script>
        var mydt = []
