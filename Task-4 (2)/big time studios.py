...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,290.55</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-0.73%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 13 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">13</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/big-time-studios">Token (1)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://bigtime.gg/">Big Time Studios</a> is a game company dedicated to crafting online adventures through space and time.</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x64bc2ca1be492be7185faa2c8835d9b824c8a194" data-bs-toggle="tooltip" data-bs-title="0x64bc2ca1be492be7185faa2c8835d9b824c8a194"><span data-highlight-target="0x64Bc2cA1Be492bE7185FAA2c8835d9b824c8a194">0x64Bc2c...24c8a194</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x64Bc2cA1Be492bE7185FAA2c8835d9b824c8a194" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x64b_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x64b_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Big Time: BIGTIME Token</td><td>0 ETH</td><td>160,629</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0x225124dbcfbd9fc3092fbe8839f89e22198bc71c" data-bs-toggle="tooltip" data-bs-title="0x225124dbcfbd9fc3092fbe8839f89e22198bc71c"><span data-highlight-target="0x225124dBCfbd9fC3092fBE8839f89e22198bc71C">0x225124...198bc71C</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x225124dBCfbd9fC3092fBE8839f89e22198bc71C" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x225_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x225_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Big Time: Deployer</td><td>0<b>.</b>03549735 ETH</td><td>34</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">0.03549735 Ether</th><th class="border-top border-bottom-0">160,663</th></tr></tfoot></table></div></div></div>

<form method="post" action="./big-time-studios" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="ql0T+PnyKoUaHL5Kdwd0nhwrGacu9iRq0NzWrb3gMCQSwdmAMtbIiXZ92hOFx8u01t89j4rLGWiPTM4V9FwuaFFVy6XWj0DF4YwYqUx6ees=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="big-time-studios">
<script>
        var mydt = []
...
output_file_path = 'Big Time Studios.json'
