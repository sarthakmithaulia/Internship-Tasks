...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,290.47</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-1.00%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 13 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">13</span> Gwei</a></span></div>
</div>
...
<input name="ctl00$ContentPlaceHolder1$hdnLabelFilter" type="hidden" id="ContentPlaceHolder1_hdnLabelFilter" value="authentication" />
<div id="ContentPlaceHolder1_divPublicNotes" class="card p-4 mb-2">
<p class="mb-0">
The process of determining whether someone or something is, in fact&nbsp;genuine.
</p>
</div>
...
output_file_path = 'Authentication.json'
