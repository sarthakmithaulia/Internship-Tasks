...
<link rel="stylesheet" href="/assets/vendor/font-awesome/css/all.min.css?v=24.1.4.0">
<link rel="stylesheet" href="/assets/vendor/autocomplete/dist/css/autocomplete.min.css?v=24.1.4.0" />
<link rel="stylesheet" href="/assets/css/theme.min.css?v=24.1.4.0">
<link rel="stylesheet" href="/assets/css/custom.css?v=24.1.4.0">
<script src="/assets/vendor/jquery/dist/jquery.min.js?v=24.1.4.0"></script>
<script type="text/javascript" src="/jss/blockies.js?v=24.1.4.0"></script>
<script type="text/javascript" src="/assets/js/theme-appearance.js?v=24.1.4.0"></script>
<style>
        .autolink-safari a {
...
<style> .dnu14sfuv2p { -ms-flex-pack: center; justify-content: center; } .ahgygpspgml { border-top: 1px solid #e7eaf3 !important; } body.dark-mode .ahgygpspgml { border-color: #18365b !important; } @media (min-width: 992px) { .byghqhvacjs { display: block !important; } } @media (min-width: 992px) { .cjlbj7y1gbv { display: inline-block !important; } }  </style>
<link rel="stylesheet" type="text/css" href="/assets/vendor/datatables/datatables.min.css?v=24.1.4.0" />
<style>
...
<script type="text/javascript" src="/assets/vendor/datatables/datatables.min.js?v=24.1.4.0"></script>
<script>
...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,266.99</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-success"> (+1.39%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 12 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">12</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/across-protocol">Token (1)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://across.to/">Across Protocol</a> is a bridging method that combines an optimistic oracle, bonded relayers and single-sided liquidity pools to provide decentralized instant transactions from rollup chains to Ethereum mainnet.</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x3b03509645713718b78951126e0a6de6f10043f5" data-bs-toggle="tooltip" data-bs-title="0x3b03509645713718b78951126e0a6de6f10043f5">0x3B0350...f10043f5</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x3B03509645713718B78951126E0A6de6f10043f5" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x3b0_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x3b0_1" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Across Config Store V2</td><td>0 ETH</td><td>23</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x937958992799bf4a9a656e6596fd10d7da5c2216" data-bs-toggle="tooltip" data-bs-title="0x937958992799bf4a9a656e6596fd10d7da5c2216">0x937958...Da5c2216</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x937958992799bF4A9a656E6596FD10d7Da5c2216" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x937_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x937_2" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Arbitrum Adapter V2</td><td>0 ETH</td><td>2</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x0d8563d3b8b3fec542aae50a530c606dac4d1c4f" data-bs-toggle="tooltip" data-bs-title="0x0d8563d3b8b3fec542aae50a530c606dac4d1c4f">0x0D8563...Ac4D1c4F</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x0D8563d3B8b3Fec542aaE50a530C606DAc4D1c4F" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x0d8_3&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x0d8_3" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Arbitrum Messenger</td><td>0 ETH</td><td>2</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x43298f9f91a4545df64748e78a2c777c580573d6" data-bs-toggle="tooltip" data-bs-title="0x43298f9f91a4545df64748e78a2c777c580573d6">0x43298F...580573d6</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x43298F9f91a4545dF64748e78a2c777c580573d6" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x432_4&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x432_4" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Badger Bridge Pool</td><td>0 ETH</td><td>205</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x33b0ec794c15d6cc705818e70d4cace7bcfb5af3" data-bs-toggle="tooltip" data-bs-title="0x33b0ec794c15d6cc705818e70d4cace7bcfb5af3">0x33B0Ec...bCfB5Af3</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x33B0Ec794c15D6Cc705818E70d4CaCe7bCfB5Af3" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x33b_5&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x33b_5" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Boba Adapter V2</td><td>0 ETH</td><td>1</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x30b44c676a05f1264d1de9cc31db5f2a945186b6" data-bs-toggle="tooltip" data-bs-title="0x30b44c676a05f1264d1de9cc31db5f2a945186b6">0x30B44C...945186b6</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x30B44C676A05F1264d1dE9cC31dB5F2A945186b6" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x30b_6&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x30b_6" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Bridge Admin</td><td>0 ETH</td><td>8</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x527e872a5c3f0c7c24fe33f2593cfb890a285084" data-bs-toggle="tooltip" data-bs-title="0x527e872a5c3f0c7c24fe33f2593cfb890a285084">0x527E87...0a285084</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x527E872a5c3f0C7c24Fe33F2593cFB890a285084" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x527_7&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x527_7" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Ethereum Adapter V2</td><td>0 ETH</td><td>1</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x5c7bcd6e7de5423a257d81b442095a1a6ced35c5" data-bs-toggle="tooltip" data-bs-title="0x5c7bcd6e7de5423a257d81b442095a1a6ced35c5">0x5c7BCd...6ced35C5</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x5c7BCd6E7De5423a257D81B442095A1a6ced35C5" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x5c7_8&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x5c7_8" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Ethereum Spoke Pool V2</td><td>0 ETH</td><td>157,162</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xb524735356985d2f267fa010d681f061dff03715" data-bs-toggle="tooltip" data-bs-title="0xb524735356985d2f267fa010d681f061dff03715">0xB52473...DfF03715</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xB524735356985D2f267FA010D681f061DfF03715" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xb52_9&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xb52_9" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Hub Pool Owner MultiSig</td><td>0<b>.</b>025 ETH</td><td>149</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xc186fa914353c44b2e33ebe05f21846f1048beda" data-bs-toggle="tooltip" data-bs-title="0xc186fa914353c44b2e33ebe05f21846f1048beda">0xc186fA...1048bEda</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xc186fA914353c44b2E33eBE05f21846F1048bEda" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xc18_10&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xc18_10" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Hub Pool V2</td><td>4<b>.</b>08898197 ETH</td><td>43,355</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x7db69eb9f52ed773e9b03f5068a1ea0275b2fd9d" data-bs-toggle="tooltip" data-bs-title="0x7db69eb9f52ed773e9b03f5068a1ea0275b2fd9d">0x7dB69e...75b2fD9d</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x7dB69eb9F52eD773E9b03f5068A1ea0275b2fD9d" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x7db_11&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x7db_11" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: LP Token Factory V2</td><td>0 ETH</td><td>1</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x4d9079bb4165aeb4084c526a32695dcfd2f77381" data-bs-toggle="tooltip" data-bs-title="0x4d9079bb4165aeb4084c526a32695dcfd2f77381">0x4D9079...d2F77381</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x4D9079Bb4165aeb4084c526a32695dCfd2F77381" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x4d9_12&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x4d9_12" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Old Ethereum Spoke Pool V2 </td><td>0<b>.</b>23496426 ETH</td><td>253,573</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x22ed83a9ee26236486f57ce8385a247e5bfb71ff" data-bs-toggle="tooltip" data-bs-title="0x22ed83a9ee26236486f57ce8385a247e5bfb71ff">0x22eD83...5bFB71fF</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x22eD83A9eE26236486F57cE8385A247E5bFB71fF" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x22e_13&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x22e_13" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Optimism Adapter V2</td><td>0 ETH</td><td>1</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x3e94e8d4316a1ebfb2245e45e6f0b8724094ce1a" data-bs-toggle="tooltip" data-bs-title="0x3e94e8d4316a1ebfb2245e45e6f0b8724094ce1a">0x3E94e8...4094CE1A</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x3E94e8d4316a1eBfb2245E45E6F0B8724094CE1A" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x3e9_14&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x3e9_14" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Polygon Adapter V2</td><td>0 ETH</td><td>1</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x48d990abda20afa1fd1da713abc041b60a922c65" data-bs-toggle="tooltip" data-bs-title="0x48d990abda20afa1fd1da713abc041b60a922c65">0x48d990...0a922c65</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x48d990AbDA20afa1fD1da713AbC041B60a922c65" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x48d_15&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x48d_15" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Polygon Token Bridger V2</td><td>0 ETH</td><td>2</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0x428ab2ba90eba0a4be7af34c9ac451ab061ac010" data-bs-toggle="tooltip" data-bs-title="0x428ab2ba90eba0a4be7af34c9ac451ab061ac010">0x428AB2...061AC010</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x428AB2BA90Eba0a4Be7aF34C9Ac451ab061AC010" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x428_16&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x428_16" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Relayer</td><td>27<b>.</b>7137607 ETH</td><td>153,522</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0x15652636f3898f550b257b89926d5566821c32e1" data-bs-toggle="tooltip" data-bs-title="0x15652636f3898f550b257b89926d5566821c32e1">0x156526...821c32E1</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x15652636f3898F550b257B89926d5566821c32E1" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x156_17&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x156_17" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Relayer 2</td><td>0<b>.</b>70716335 ETH</td><td>128,951</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x4060dba72344da74edaeeae51a71a57f7e96b6b4" data-bs-toggle="tooltip" data-bs-title="0x4060dba72344da74edaeeae51a71a57f7e96b6b4">0x4060dB...7E96b6b4</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x4060dBA72344DA74EDaEEAe51a71a57F7E96b6b4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x406_18&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x406_18" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: Skinny Optimistic Oracle</td><td>0 ETH</td><td>10</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xdfe0ec39291e3b60aca122908f86809c9ee64e90" data-bs-toggle="tooltip" data-bs-title="0xdfe0ec39291e3b60aca122908f86809c9ee64e90">0xdfe0ec...9eE64E90</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xdfe0ec39291e3b60ACa122908f86809c9eE64E90" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xdfe_19&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xdfe_19" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: UMA Bridge Pool</td><td>0 ETH</td><td>97</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x256c8919ce1ab0e33974cf6aa9c71561ef3017b6" data-bs-toggle="tooltip" data-bs-title="0x256c8919ce1ab0e33974cf6aa9c71561ef3017b6">0x256C89...Ef3017b6</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x256C8919CE1AB0e33974CF6AA9c71561Ef3017b6" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x256_20&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x256_20" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: USDC Bridge Pool</td><td>0 ETH</td><td>4,892</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x02fbb64517e1c6ed69a6faa3abf37db0482f1152" data-bs-toggle="tooltip" data-bs-title="0x02fbb64517e1c6ed69a6faa3abf37db0482f1152">0x02fbb6...482f1152</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x02fbb64517E1c6ED69a6FAa3ABf37Db0482f1152" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x02f_21&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x02f_21" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: WBTC Bridge Pool</td><td>0 ETH</td><td>276</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x7355efc63ae731f584380a9838292c7046c1e433" data-bs-toggle="tooltip" data-bs-title="0x7355efc63ae731f584380a9838292c7046c1e433">0x7355Ef...46c1e433</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x7355Efc63Ae731f584380a9838292c7046c1e433" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x735_22&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x735_22" class="far fa-copy fa-fw "></i> </a></span></span></td><td>Across Protocol: WETH Bridge Pool</td><td>0 ETH</td><td>26,876</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 22 Accounts</th><th class="border-top border-bottom-0">32.76987028 Ether</th><th class="border-top border-bottom-0">769,110</th></tr></tfoot></table></div></div></div>

<form method="post" action="./across-protocol" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="+PFQDiscDKYxi/Tv/NFI2PvH8YdSgY8c6q4GYOHQhNpSfYuX/JOirtD1e/6nADOJszGRwmV0qllir5z7jZUZGzVN8GCjZnwVpBarFsEQVCs=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="across-protocol">
<script>
        var mydt = []
...
<script src="/assets/vendor/jquery-ui/jquery-ui.min.js?v=24.1.4.0"></script>
<script src="/assets/vendor/jquery-migrate/dist/jquery-migrate.min.js?v=24.1.4.0"></script>
<script src="/assets/vendor/bootstrap/bootstrap.bundle.min.js?v=24.1.4.0"></script>

<script src="/assets/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js?v=24.1.4.0"></script>
<script src="/assets/vendor/clipboard/dist/clipboard.min.js?v=24.1.4.0"></script>

<script src="/assets/js/hs.core.js?v=24.1.4.0"></script>
<script src="/assets/js/components/hs.cubeportfolio.js?v=24.1.4.0"></script>
<script src="/assets/js/custom/combine-js-bottom2.js?v=24.1.4.0"></script>
<script src="/assets/vendor/autocomplete/dist/js/autocomplete.min.js?v=24.1.4.0"></script>
<script src="/assets/js/custom/ether-search.js?v=24.1.4.0"></script>

<script src="/assets/js/app.min.js?v=24.1.4.0"></script>
...
<script type="text/javascript">
        var sid = '6c67e6555c8a6a858295766cc4506a84';
...
<script src="/assets/js/custom/web3.min.js?v=24.1.4.0"></script>
<script type="text/javascript">
        var web3ojb;
        var isTestnet = 'false';
        var chain = 'Mainnet'
...
json_file_path = 'Accessprotocol.json'
