...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,309.59</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-0.32%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 16 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">16</span> Gwei</a></span></div>
</div>
...
<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://aladdin.club/">AladdinDAO</a> is a decentralized network to shift crypto investments from venture capitalists to wisdom of crowds through collective value discovery.
</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xc40549aa1d05c30af23a1c4a5af6ba11fcafe23f" data-bs-toggle="tooltip" data-bs-title="0xc40549aa1d05c30af23a1c4a5af6ba11fcafe23f"><span data-highlight-target="0xc40549aa1D05C30af23a1C4a5af6bA11FCAFe23F">0xc40549...FCAFe23F</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xc40549aa1D05C30af23a1C4a5af6bA11FCAFe23F" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xc40_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xc40_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>AladdinDAO: Community Multisig</td><td>2<b>.</b>09471748 ETH</td><td>82</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x28c921adac4c1072658eb01a28da06b5f651ef62" data-bs-toggle="tooltip" data-bs-title="0x28c921adac4c1072658eb01a28da06b5f651ef62"><span data-highlight-target="0x28c921adAC4c1072658eB01a28DA06b5F651eF62">0x28c921...F651eF62</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x28c921adAC4c1072658eB01a28DA06b5F651eF62" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x28c_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x28c_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td>AladdinDAO: Management Multisig</td><td>0<b>.</b>21763664 ETH</td><td>220</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">2.31235412 Ether</th><th class="border-top border-bottom-0">302</th></tr></tfoot></table></div></div></div>

<form method="post" action="./aladdindao" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="14s+WGipJS1JNy4x+yR0LGuQ99gxrqQu2tvIYWQ4azePaMR6kfkISWisOF+4mZxblnWGI+RCZ1zVO1FAPhw8ffqstcuZdwsv4RJFrGTaA/U=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="aladdindao">
<script>
        var mydt = []
...
json_file_path = 'Alladindao.json'
