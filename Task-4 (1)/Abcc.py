...
<style> .d9vunw2kwxc { -ms-flex-pack: center; justify-content: center; } .afcttusffd7 { border-top: 1px solid #e7eaf3 !important; } body.dark-mode .afcttusffd7 { border-color: #18365b !important; } @media (min-width: 992px) { .bcgwkwn15eq { display: block !important; } } @media (min-width: 992px) { .clsa1sjjugl { display: inline-block !important; } }  </style>
...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,254.24</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-success"> (+2.63%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 12 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">12</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/abcc">Token (1)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://abcc.com/en" target="_blank"><strong>ABCC</strong></a> is a world-class Digital Аssеts exchange. They aim to provide a frictionless, user-centric trading experience.
</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0x05f51aab068caa6ab7eeb672f88c180f67f17ec7" data-bs-toggle="tooltip" data-bs-title="0x05f51aab068caa6ab7eeb672f88c180f67f17ec7">0x05f51A...67F17eC7</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x05f51AAb068CAa6Ab7eeb672f88c180f67F17eC7" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x05f_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x05f_1" class="far fa-copy fa-fw "></i> </a></span></span></td><td>ABCC</td><td>0 ETH</td><td>59,516</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xbf8fb919a8bbf28e590852aef2d284494ebc0657" data-bs-toggle="tooltip" data-bs-title="0xbf8fb919a8bbf28e590852aef2d284494ebc0657">0xbf8fB9...4eBC0657</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xbf8fB919A8bbF28e590852AeF2D284494eBC0657" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xbf8_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xbf8_2" class="far fa-copy fa-fw "></i> </a></span></span></td><td>ABCC: AT Token</td><td>0 ETH</td><td>6,983</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">0 Ether</th><th class="border-top border-bottom-0">66,499</th></tr></tfoot></table></div></div></div>

<form method="post" action="./abcc" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="lnieAVyhBpLH2XY5aL4nXIpi3CJ0f7F/11jiMWpUTf6Evhiws0zz5CuuAQf0dhwrdkgIy2uwVGRSIlA1WQLW7Z8xaKchYr2a6feQ2uEahiM=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="abcc">
<script>
        var mydt = []
...
combined_extracted_data = {
    'name': additional_content,  # Replace with the actual value
    'Main': None,  # Replace with the actual value
    'Others': None,  # Replace with the actual value
    'Legacy': None,  # Replace with the actual value
    'subhead': table_data
}

# Save the JSON data to a file
json_file_path = 'ABCC.json'
