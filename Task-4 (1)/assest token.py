...
<style> .d9fle1f8sfp { -ms-flex-pack: center; justify-content: center; } .a4kcsttytwv { border-top: 1px solid #e7eaf3 !important; } body.dark-mode .a4kcsttytwv { border-color: #18365b !important; } @media (min-width: 992px) { .bncecxmv2uy { display: block !important; } } @media (min-width: 992px) { .cyxkfmag72q { display: inline-block !important; } }  </style>
...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,300.22</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-success"> (+0.01%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 16 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">16</span> Gwei</a></span></div>
</div>
...
<input name="ctl00$ContentPlaceHolder1$hdnLabelFilter" type="hidden" id="ContentPlaceHolder1_hdnLabelFilter" value="asset-token" />
<div id="ContentPlaceHolder1_divPublicNotes" class="card p-4 mb-2">
<p class="mb-0">
An asset token is the tokenization of physical real-world assets on the blockchain. It represents a non-security asset ownership token.
</p>
</div>
...
output_file_path = 'Asset token.json'
