...
<style> .dhxlrkklkzc { -ms-flex-pack: center; justify-content: center; } .amnyuawcjke { border-top: 1px solid #e7eaf3 !important; } body.dark-mode .amnyuawcjke { border-color: #18365b !important; } @media (min-width: 992px) { .bccwdwi1ild { display: block !important; } } @media (min-width: 992px) { .clsvxj3ti3m { display: inline-block !important; } }  </style>
...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,471.84</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-success"> (+0.06%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 15 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">15</span> Gwei</a></span></div>
</div>
...
<input name="ctl00$ContentPlaceHolder1$hdnLabelFilter" type="hidden" id="ContentPlaceHolder1_hdnLabelFilter" value="3d-printing" />
...
<script type="text/javascript" src="/assets/js/custom/datatables/plugins/custompagination.js?v=24.1.3.0"></script>
<script>
...
# Fill null values in 'Main', 'Others', and 'Legacy'
...
output_file_path = '3D-Printing.json'
