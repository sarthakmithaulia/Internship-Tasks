...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,290.69</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-0.99%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 12 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">12</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/augur">Tokens (5)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><strong><a href="https://www.augur.net/" rel="nofollow" target="_blank">Augur</a>:</strong> The world’s most accessible, no-limit betting exchange.</div></div></div>

<ul class="nav nav-pills text-nowrap snap-x-mandatory overflow-x-auto flex-nowrap py-3 gap-2" role="tablist"><li class="nav-item snap-align-start"><a val="1" class="nav-link active" name="Main" onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content" type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Main (2)</a></li><li class="nav-item snap-align-start"><a val="3-0" class="nav-link " name="Others" onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content" type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Others (8)</a></li><li class="nav-item snap-align-start"><a val="2" class="nav-link " name="Legacy" onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content" type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Legacy (1)</a></li></ul>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-1" role="tabpanel" aria-labelledby="1-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-1"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-1"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xd5524179cb7ae012f5b642c1d6d700bbaa76b96b" data-bs-toggle="tooltip" data-bs-title="0xd5524179cb7ae012f5b642c1d6d700bbaa76b96b"><span data-highlight-target="0xd5524179cB7AE012f5B642C1D6D700Bbaa76B96b">0xd55241...aa76B96b</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0xd5524179cB7AE012f5B642C1D6D700Bbaa76B96b" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xd55_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xd55_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Augur: Delegator</td><td>778<b>.</b>07053063 ETH</td><td>4,770</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x221657776846890989a759ba2973e427dff5c9bb" data-bs-toggle="tooltip" data-bs-title="0x221657776846890989a759ba2973e427dff5c9bb"><span data-highlight-target="0x221657776846890989a759BA2973e427DfF5C9bB">0x221657...DfF5C9bB</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x221657776846890989a759BA2973e427DfF5C9bB" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x221_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x221_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td>Augur: REPv2 Token</td><td>0 ETH</td><td>138,961</td></tr></tbody><tfoot id="sublabel-1"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">778.07053063 Ether</th><th class="border-top border-bottom-0">143,731</th></tr></tfoot></table></div></div><div class="tab-pane fade " id="subcattab-3-0" role="tabpanel" aria-labelledby="3-0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-3-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-3-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody></tbody><tfoot id="sublabel-3-0" class="hideFooter"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 8 Accounts</th><th class="border-top border-bottom-0">0.46027379 Ether</th><th class="border-top border-bottom-0">4,616</th></tr></tfoot></table></div></div><div class="tab-pane fade " id="subcattab-2" role="tabpanel" aria-labelledby="2-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-2"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-2"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody></tbody><tfoot id="sublabel-2" class="hideFooter"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 1 Account</th><th class="border-top border-bottom-0">0 Ether</th><th class="border-top border-bottom-0">281,657</th></tr></tfoot></table></div></div></div>

<form method="post" action="./augur" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="GJVbSSZxyKApym93A74KLfjouegzIa/E4K8bmswfIxDSw8FTjn1fLTSrz2KYUe6Ts7aSfcAvfT2ugDQaMUM8EW7RdEzRlzNvPQ85C2cQvn0=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="augur">
<script>
        var mydt = []
