...
<style> .dxqnhqb7djw { -ms-flex-pack: center; justify-content: center; } .ahptmheamme { border-top: 1px solid #e7eaf3 !important; } body.dark-mode .ahptmheamme { border-color: #18365b !important; } @media (min-width: 992px) { .bbedxl1vrvm { display: block !important; } } @media (min-width: 992px) { .cjauv274eb8 { display: inline-block !important; } }  </style>
...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,486.29</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-1.33%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 20 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">20</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/1inch">Tokens (6)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://1inch.io/">1inch Network</a>&nbsp;is a DEX aggregator solution that searches deals across multiple liquidity sources, offering users better rates than individual exchanges.
</div></div></div>

<ul class="nav nav-pills text-nowrap snap-x-mandatory overflow-x-auto flex-nowrap py-3 gap-2" role="tablist"><li class="nav-item snap-align-start"><a val="1" class="nav-link active" name="Main" onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content" type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Main (6)</a></li><li class="nav-item snap-align-start"><a val="3-0" class="nav-link " name="Others" onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content" type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Others (27)</a></li><li class="nav-item snap-align-start"><a val="2" class="nav-link " name="Legacy" onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content" type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Legacy (1)</a></li></ul>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-1" role="tabpanel" aria-labelledby="1-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-1"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-1"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x111111125434b319222cdbf8c261674adb56f3ae" data-bs-toggle="tooltip" data-bs-title="0x111111125434b319222cdbf8c261674adb56f3ae">0x111111...DB56F3ae</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x111111125434b319222CdBf8C261674aDB56F3ae" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x111_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x111_1" class="far fa-copy fa-fw "></i> </a></span></span></td><td>1inch v2: Aggregation Router</td><td>0 ETH</td><td>703,935</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x11111112542d85b3ef69ae05771c2dccff4faa26" data-bs-toggle="tooltip" data-bs-title="0x11111112542d85b3ef69ae05771c2dccff4faa26">0x111111...ff4fAa26</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x11111112542D85B3EF69AE05771c2dCCff4fAa26" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x111_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x111_2" class="far fa-copy fa-fw "></i> </a></span></span></td><td>1inch v3: Aggregation Router</td><td>0 ETH</td><td>1,930,430</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x1111111254fb6c44bac0bed2854e76f90643097d" data-bs-toggle="tooltip" data-bs-title="0x1111111254fb6c44bac0bed2854e76f90643097d">0x111111...0643097d</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x1111111254fb6c44bAC0beD2854e76F90643097d" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x111_3&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x111_3" class="far fa-copy fa-fw "></i> </a></span></span></td><td>1inch v4: Aggregation Router</td><td>0 ETH</td><td>3,085,729</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x0000000000004946c0e9f43f4dee607b0ef1fa1c" data-bs-toggle="tooltip" data-bs-title="0x0000000000004946c0e9f43f4dee607b0ef1fa1c">0x000000...0eF1fA1c</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x0000000000004946c0e9F43F4Dee607b0eF1fA1c" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x000_4&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x000_4" class="far fa-copy fa-fw "></i> </a></span></span></td><td>1inch: CHI Token</td><td>0 ETH</td><td>133,892</td></tr><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x11111254369792b2ca5d084ab5eea397ca8fa48b" data-bs-toggle="tooltip" data-bs-title="0x11111254369792b2ca5d084ab5eea397ca8fa48b">0x111112...cA8fa48B</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x11111254369792b2Ca5d084aB5eEA397cA8fa48B" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x111_5&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x111_5" class="far fa-copy fa-fw "></i> </a></span></span></td><td>1inch: Exchange 2</td><td>0 ETH</td><td>348,930</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xe069cb01d06ba617bcdf789bf2ff0d5e5ca20c71" data-bs-toggle="tooltip" data-bs-title="0xe069cb01d06ba617bcdf789bf2ff0d5e5ca20c71">0xe069CB...5ca20C71</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xe069CB01D06bA617bCDf789bf2ff0D5E5ca20C71" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xe06_6&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xe06_6" class="far fa-copy fa-fw "></i> </a></span></span></td><td>1inch: Router 2</td><td>0 ETH</td><td>2</td></tr></tbody><tfoot id="sublabel-1"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 6 Accounts</th><th class="border-top border-bottom-0">0 Ether</th><th class="border-top border-bottom-0">6,202,918</th></tr></tfoot></table></div></div><div class="tab-pane fade " id="subcattab-3-0" role="tabpanel" aria-labelledby="3-0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-3-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-3-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody></tbody><tfoot id="sublabel-3-0" class="hideFooter"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 27 Accounts</th><th class="border-top border-bottom-0">262.71363409 Ether</th><th class="border-top border-bottom-0">4,657,394</th></tr></tfoot></table></div></div><div class="tab-pane fade " id="subcattab-2" role="tabpanel" aria-labelledby="2-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-2"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-2"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody></tbody><tfoot id="sublabel-2" class="hideFooter"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 1 Account</th><th class="border-top border-bottom-0">0 Ether</th><th class="border-top border-bottom-0">1</th></tr></tfoot></table></div></div></div>

<form method="post" action="./1inch" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="inuZWxY+pKItJXXl7hJoWfCLMNFpcCBGgDF3rE9cfenyQrdLi61CRUd61gjsgBIpgkhPtdxKUF+XSHOQzLZZoKOc5vGN+s0TUXtnG/Qg5Hs=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="1inch">
<script>
        var mydt = []
...
# Extract data from the additional section
...
legacy_value = int(re.search(r'\d+', soup.find('a', {'name': 'Legacy'}).text).group())
