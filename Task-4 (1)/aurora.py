...
<div class="text-muted"><span class="text-muted">ETH Price:</span> <a href="/chart/etherprice">$2,290.12</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-danger"> (-1.02%)</span></span></div><div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas: <span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 13 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">13</span> Gwei</a></span></div>
</div>
...
<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/aurora">Token (1)</a></div>


<div class="card p-4 mb-2"><div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i><div><a href="https://aurora.dev/">Aurora</a> provides Ethereum compatibility, NEAR Protocol scalability, and industry-first user experience through affordable transactions.</div></div></div>
...
<div class="tab-content" id="tabContent"><div class="tab-pane fade show active" id="subcattab-0" role="tabpanel" aria-labelledby="0-tab"><div class="table-responsive " id="paywall_mask_table-subcatid-0"><table class="table table-hover table-align-middle mb-0" style="width:100%" id="table-subcatid-0"><thead class="align-middle text-nowrap"><tr><th scope="col" width="370">Address</th><th class="remove-icon" scope="col">Name Tag</th><th scope="col"> Balance</th><th scope="col"> Txn Count</th></tr></thead><tbody><tr class="odd"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><a class="me-1" href="/address/0x015e634c7c1311a9034220c28d3d12b7f710a3b1" data-bs-toggle="tooltip" data-bs-title="0x015e634c7c1311a9034220c28d3d12b7f710a3b1"><span data-highlight-target="0x015e634C7C1311A9034220c28d3D12b7f710a3b1">0x015e63...f710a3b1</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x015e634C7C1311A9034220c28d3D12b7f710a3b1" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x015_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x015_1" class="far fa-copy fa-fw"></i> </a></span></span></td><td>NEAR Protocol: Deployer</td><td>5<b>.</b>92824882 ETH</td><td>5,921</td></tr><tr class="even"><td class="align-items-center"><span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x85f17cf997934a597031b2e18a9ab6ebd4b9f6a4" data-bs-toggle="tooltip" data-bs-title="0x85f17cf997934a597031b2e18a9ab6ebd4b9f6a4"><span data-highlight-target="0x85F17Cf997934a597031b2E18a9aB6ebD4B9f6a4">0x85F17C...D4B9f6a4</span></a> <a class="js-clipboard link-secondary  " href="javascript:;" data-clipboard-text="0x85F17Cf997934a597031b2E18a9aB6ebD4B9f6a4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x85f_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x85f_2" class="far fa-copy fa-fw"></i> </a></span></span></td><td>NEAR Protocol: NEAR Token</td><td>0 ETH</td><td>8,259</td></tr></tbody><tfoot id="sublabel-0"><tr class="table-active"><th class="border-top border-bottom-0"></th><th class="border-top border-bottom-0">Sum of 2 Accounts</th><th class="border-top border-bottom-0">5.92824882 Ether</th><th class="border-top border-bottom-0">14,180</th></tr></tfoot></table></div></div></div>

<form method="post" action="./aurora" id="frmTblFooter">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="ybtZpjGxjTqXoJfM27LCwvpNc89g6uDIP2k0MzVI9vdaOJIPGwd/Hpt79Q1aGFr3rXm8Ssup3nB6e0rY3mUczT5bSYNGwKMArTUtwN//TK0=" />
</div>
<div class="aspNetHidden">
...
<input type="hidden" id="hdnLabelFilter" value="aurora">
<script>
        var mydt = []
