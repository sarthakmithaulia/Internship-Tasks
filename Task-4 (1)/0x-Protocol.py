...
<head>
	...
	<meta name="Description"
		content="The top accounts in Ethereum in descending order by the number of Ether (ETH) balance in an account and the percentage of the Ether (ETH) that the account hold." />
	<meta name="keywords" content="ethereum, explorer, ether, search, blockchain, crypto, currency" />
	<meta name="format-detection" content="telephone=no" />
	<meta property="og:title" content="Ethereum Top Accounts by ETH Balance | Etherscan" />
	<meta property="og:description"
		content="The top accounts in Ethereum in descending order by the number of Ether (ETH) balance in an account and the percentage of the Ether (ETH) that the account hold." />
	<meta property="og:type" content="website" />
	<meta property="og:site_name" content="Ethereum (ETH) Blockchain Explorer" />
	<meta property="og:url" content="http://etherscan.io/accounts" />
	<meta property="og:image" content="https://etherscan.io/images/brandassets/etherscan-logo-circle.jpg" />
	<meta property="og:image:url" content="https://etherscan.io/images/brandassets/etherscan-logo-r.jpg" />
	<meta property="og:image:alt" content="Visit Etherscan.io" />
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content="Ethereum Top Accounts by ETH Balance | Etherscan" />
	<meta property="twitter:description"
		content="The top accounts in Ethereum in descending order by the number of Ether (ETH) balance in an account and the percentage of the Ether (ETH) that the account hold." />
	<meta name="twitter:site" content="@etherscan" />
	<meta property="twitter:image" content="https://etherscan.io/images/brandassets/etherscan-logo-circle.jpg" />
	...
	<link rel="stylesheet" href="/assets/vendor/font-awesome/css/all.min.css?v=24.1.2.1">
	<link rel="stylesheet" href="/assets/vendor/autocomplete/dist/css/autocomplete.min.css?v=24.1.2.1" />
	<link rel="stylesheet" href="/assets/css/theme.min.css?v=24.1.2.1">
	<link rel="stylesheet" href="/assets/css/custom.css?v=24.1.2.1">
	<script src="/assets/vendor/jquery/dist/jquery.min.js?v=24.1.2.1"></script>
	<script type="text/javascript" src="/jss/blockies.js?v=24.1.2.1"></script>
	<script type="text/javascript" src="/assets/js/theme-appearance.js?v=24.1.2.1"></script>
	<style>
		.autolink-safari a {
	...
	<link rel="stylesheet" type="text/css" href="/assets/vendor/datatables/datatables.min.css?v=24.1.2.1" />
	<style>
	...
	<script type="text/javascript" src="/assets/vendor/datatables/datatables.min.js?v=24.1.2.1"></script>
	<script>
	...
	<section id="masterTopBar" class="sticky-top bg-white border-bottom py-2 d-print-none">
		<div class="container-xxl d-flex align-items-center justify-content-between">
			<div id="ethPrice" class="d-none d-md-flex align-items-center gap-4 w-100 fs-sm">
				<div class="text-muted"><span class="text-muted">ETH Price:</span> <a
						href="/chart/etherprice">$2,545.34</a><span data-bs-toggle="tooltip" data-bs-placement="top" title="Changes in the last 24 hours"><span class="text-success"> (+0.57%)</span></span>
				</div>
				<div class="text-muted d-none d-lg-block"><i class="fad fa-gas-pump me-1"></i> Gas:
					<span id="spanGasTooltip" data-bs-toggle="tooltip" data-bs-html="true" title="Base Fee: 30 Gwei<br>Priority Fee: 0 Gwei"><a href="/gastracker"><span class="gasPricePlaceHolder">30</span>
					Gwei</a></span></div>
			</div>
...
<i class="far fa-moon fa-fw dropdown-item-icon theme-icon me-1" data-href="#fa-moon"></i> Dark
						...
						<li>
							<a class="dropdown-item" href="/settings">
								<i class="far fa-gear fa-fw dropdown-item-icon me-1"></i> Site Settings
					...
					<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
						<ul class="navbar-nav gap-1 gap-lg-0 pt-4 pt-lg-0">
							...
							<li class="nav-item dropdown">
								<a href="javascript:;" id="LI_blockchain" class="nav-link dropdown-toggle active"
									role="button" data-bs-toggle="dropdown" aria-expanded="false">Blockchain</a>
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-border" style="min-width: 14rem;">
									...
									<li>
										<a href="https://info.etherscan.com/newsletters/" id="LI60"
											class="dropdown-item">
											Newsletter
										</a>
									</li>
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-border" style="min-width: 14rem;">
									...
									<li>
										<a href="https://docs.etherscan.io/" id="LI6" class="dropdown-item"
											target="_blank">
											API Documentation
										</a>
									</li>
											...
											<ul class="list-unstyled">
												...
												<li>
													<a href="/dex" id="LI4" class="dropdown-item">
														<i class="far fa-arrow-right-arrow-left dropdown-item-icon fa-fw me-1"></i>DEX
														Tracker
													</a>
												</li>
												<li>
												...
												<li>
													<a href="/name-lookup" id="LI26" class="dropdown-item">
														<i class="far fa-magnifying-glass-chart dropdown-item-icon fa-fw me-1"></i>Domain
														Name Lookup
													</a>
												</li>
											</ul>
											...
											<ul class="list-unstyled">
												<li>
													<a href="/tokenapprovalchecker" id="LI49" class="dropdown-item">
														<i class="far fa-shield-keyhole dropdown-item-icon fa-fw me-1"></i>Token
														Approvals
												...
												<li>
													<a href="/verifiedSignatures" id="LI29" class="dropdown-item">
														<i class="far fa-signature-lock dropdown-item-icon fa-fw me-1"></i>Verified
														Signature
													</a>
												</li>
												<li>
													<a class="dropdown-item" href="/idm">
														<i class="far fa-message-lines dropdown-item-icon fa-fw me-1"></i>Input
														Data Messages (IDM)
														<span class="badge border bg-light text-muted">Beta</span>
													</a>
												</li>
												...
												<li>
													<a class="dropdown-item" href="https://chat.blockscan.com"
														target="_blank">
														<i class="far fa-messages dropdown-item-icon fa-fw me-1"></i>Blockscan
														Chat
								...
								<ul class="dropdown-menu dropdown-menu-border" style="min-width: 14rem;">
									...
									<li>
										<a href="https://cn.etherscan.com/?lang=zh-CN" id="LI_Mainnet_CN_1"
											class="dropdown-item">
											Ethereum Mainnet
											<span class="badge border bg-light text-dark ms-1">CN</span>
										</a>
									</li>
									<li>
...
<i class="far fa-moon-stars fa-fw dropdown-item-icon theme-icon me-1" data-href="#fa-moon"></i> Dark
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-border"
									style="min-width: 14rem; right: 0; left: auto;">
									<li>
									...
									<li>
										<a class="btn btn-sm btn-soft-primary d-lg-block py-2 px-4"
...
0x Protocol
		...
		<section class="container-xxl pt-5 pb-12">
			...
			<div class="d-flex align-items-center gap-2 mb-3"><span class="fw-bold">Related labels </span><a
					class="btn btn-sm btn-secondary rounded-pill" href="/tokens/label/0x-protocol">Token (1)</a></div>


			<div class="card p-4 mb-2">
				<div class="d-flex align-items-basline gap-3"><i class="far fa-sparkles fs-5"></i>
					<div><a href="https://0x.org/" rel="nofollow"
							target="_blank"><strong>0x Protocol</strong></a>&nbsp;is an open protocol that enables the
			...
			<ul class="nav nav-pills text-nowrap snap-x-mandatory overflow-x-auto flex-nowrap py-3 gap-2"
				role="tablist">
				<li class="nav-item snap-align-start"><a val="1" class="nav-link active" name="Main"
						onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content"
						type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Main (26)</a></li>
				<li class="nav-item snap-align-start"><a val="3-0" class="nav-link " name="Others"
						onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content"
						type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Others (23)</a></li>
				<li class="nav-item snap-align-start"><a val="2" class="nav-link " name="Legacy"
						onclick="selectTab(this)" id="tab-xx" data-bs-toggle="pill" data-bs-target="#tab-xx-content"
						type="button" role="tab" aria-controls="tab-1-content" aria-selected="true">Legacy (9)</a></li>
			</ul>
			...
			<div class="card">
				...
				<div class="tab-content" id="tabContent">
					<div class="tab-pane fade show active" id="subcattab-1" role="tabpanel" aria-labelledby="1-tab">
						<div class="table-responsive " id="paywall_mask_table-subcatid-1">
							<table class="table table-hover table-align-middle mb-0" style="width:100%"
								id="table-subcatid-1">
								...
								<tbody>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xdffe798c7172dd6deb32baee68af322e8f495ce0" data-bs-toggle="tooltip" data-bs-title="0xdffe798c7172dd6deb32baee68af322e8f495ce0">0xDFFE79...8F495CE0</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xDFFE798c7172dd6deb32bAeE68Af322e8F495CE0" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xdff_1&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xdff_1" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Asset Proxy Owner</td>
										<td>0 ETH</td>
										<td>39</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x45797531b873fd5e519477a070a955764c1a5b07" data-bs-toggle="tooltip" data-bs-title="0x45797531b873fd5e519477a070a955764c1a5b07">0x457975...4C1A5B07</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x45797531b873fd5E519477A070a955764C1A5B07" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x457_2&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x457_2" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Coordinator Registry V3</td>
										<td>0 ETH</td>
										<td>4</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x38a795580d0f687e399913a00ddef6a17612c722" data-bs-toggle="tooltip" data-bs-title="0x38a795580d0f687e399913a00ddef6a17612c722">0x38A795...7612C722</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x38A795580D0F687E399913a00dDef6a17612C722" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x38a_3&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x38a_3" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Coordinator V3</td>
										<td>0 ETH</td>
										<td>14,531</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xccc2431a7335f21d9268ba62f0b32b0f2efc463f" data-bs-toggle="tooltip" data-bs-title="0xccc2431a7335f21d9268ba62f0b32b0f2efc463f">0xcCc243...2EFC463f</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xcCc2431a7335F21d9268bA62F0B32B0f2EFC463f" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xccc_4&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xccc_4" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Dev Utils</td>
										<td>0 ETH</td>
										<td>1</td>
									...
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x7eefbd48fd63d441ec7435d024ec7c5131019add" data-bs-toggle="tooltip" data-bs-title="0x7eefbd48fd63d441ec7435d024ec7c5131019add">0x7EeFBd...31019ADd</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x7EeFBd48FD63d441Ec7435D024EC7c5131019ADd" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x7ee_5&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x7ee_5" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: ERC1155 Proxy V3</td>
										<td>0 ETH</td>
										<td>4</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x8ed95d1746bf1e4dab58d8ed4724f1ef95b20db0" data-bs-toggle="tooltip" data-bs-title="0x8ed95d1746bf1e4dab58d8ed4724f1ef95b20db0">0x8ED95d...95B20Db0</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x8ED95d1746bf1E4dAb58d8ED4724f1Ef95B20Db0" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x8ed_6&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x8ed_6" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Erc20 Bridge Proxy</td>
										<td>0 ETH</td>
										<td>4</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x95e6f48254609a6ee006f7d493c8e5fb97094cef" data-bs-toggle="tooltip" data-bs-title="0x95e6f48254609a6ee006f7d493c8e5fb97094cef">0x95E6F4...97094ceF</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x95E6F48254609A6ee006F7D493c8e5fB97094ceF" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x95e_7&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x95e_7" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: ERC20 Proxy V3</td>
										<td>0 ETH</td>
										<td>59</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xefc70a1b18c432bdc64b596838b4d138f6bc6cad" data-bs-toggle="tooltip" data-bs-title="0xefc70a1b18c432bdc64b596838b4d138f6bc6cad">0xeFc70A...f6bC6cad</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xeFc70A1B18C432bdc64b596838B4D138f6bC6cad" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xefc_8&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xefc_8" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: ERC721 Proxy V3</td>
										<td>0 ETH</td>
										<td>4</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x0ac2d6f5f5afc669d3ca38f830dad2b4f238ad3f" data-bs-toggle="tooltip" data-bs-title="0x0ac2d6f5f5afc669d3ca38f830dad2b4f238ad3f">0x0ac2D6...F238ad3F</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x0ac2D6f5f5aFc669d3Ca38f830DaD2b4F238ad3F" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x0ac_9&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x0ac_9" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Eth2Dai Bridge</td>
										<td>0 ETH</td>
										<td>1</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xdef1c0ded9bec7f1a1670819833240f027b25eff" data-bs-toggle="tooltip" data-bs-title="0xdef1c0ded9bec7f1a1670819833240f027b25eff">0xDef1C0...27b25EfF</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xDef1C0ded9bec7F1a1670819833240f027b25EfF" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xdef_10&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xdef_10" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Exchange Proxy</td>
										<td>0<b>.</b>29358897 ETH</td>
										<td>3,775,166</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xf740b67da229f2f10bcbd38a7979992fcc71b8eb" data-bs-toggle="tooltip" data-bs-title="0xf740b67da229f2f10bcbd38a7979992fcc71b8eb">0xF740B6...CC71B8Eb</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xF740B67dA229f2f10bcBd38A7979992fCC71B8Eb" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xf74_11&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xf74_11" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Exchange Proxy Allowance Target</td>
										<td>0 ETH</td>
										<td>0</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x080bf510fcbf18b91105470639e9561022937712" data-bs-toggle="tooltip" data-bs-title="0x080bf510fcbf18b91105470639e9561022937712">0x080bf5...22937712</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x080bf510FCbF18b91105470639e9561022937712" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x080_12&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x080_12" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Exchange v2.1</td>
										<td>0 ETH</td>
										<td>479,105</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x61935cbdd02287b511119ddb11aeb42f1593b7ef" data-bs-toggle="tooltip" data-bs-title="0x61935cbdd02287b511119ddb11aeb42f1593b7ef">0x61935C...1593b7Ef</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x61935CbDd02287B511119DDb11Aeb42F1593b7Ef" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x619_13&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x619_13" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Exchange v3</td>
										<td>0 ETH</td>
										<td>893,443</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x206376e8940e42538781cd94ef024df3c1e0fd43" data-bs-toggle="tooltip" data-bs-title="0x206376e8940e42538781cd94ef024df3c1e0fd43">0x206376...C1E0fD43</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x206376e8940E42538781cD94eF024Df3C1E0fD43" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x206_14&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x206_14" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Ext Dev Pool</td>
										<td>0 ETH</td>
										<td>73</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xa3ac9844514b96bb502627ca9dceb57c4be289e3" data-bs-toggle="tooltip" data-bs-title="0xa3ac9844514b96bb502627ca9dceb57c4be289e3">0xA3ac98...4bE289e3</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xA3ac9844514b96bB502627ca9dcEB57C4bE289e3" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xa3a_15&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xa3a_15" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Forwarder 2</td>
										<td>0 ETH</td>
										<td>8,887</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x7d3455421bbc5ed534a83c88fd80387dc8271392" data-bs-toggle="tooltip" data-bs-title="0x7d3455421bbc5ed534a83c88fd80387dc8271392">0x7D3455...c8271392</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x7D3455421BbC5Ed534a83c88FD80387dc8271392" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x7d3_16&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x7d3_16" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Governor V3</td>
										<td>0 ETH</td>
										<td>43</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xef701d5389ae74503d633396c4d654eabedc9d78" data-bs-toggle="tooltip" data-bs-title="0xef701d5389ae74503d633396c4d654eabedc9d78">0xEf701d...BedC9D78</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xEf701d5389aE74503D633396c4d654eABedC9D78" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xef7_17&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xef7_17" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Multi Asset Proxy V3</td>
										<td>0 ETH</td>
										<td>4</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xa09329c6003c9a5402102e226417738ee22cf1f2" data-bs-toggle="tooltip" data-bs-title="0xa09329c6003c9a5402102e226417738ee22cf1f2">0xa09329...E22cF1F2</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xa09329C6003c9a5402102e226417738EE22cF1F2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xa09_18&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xa09_18" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Order Validator</td>
										<td>0 ETH</td>
										<td>1</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x2a17c35ff147b32f13f19f2e311446eeb02503f3" data-bs-toggle="tooltip" data-bs-title="0x2a17c35ff147b32f13f19f2e311446eeb02503f3">0x2a17c3...B02503F3</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x2a17c35FF147b32f13F19F2E311446eEB02503F3" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x2a1_19&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x2a1_19" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Staking</td>
										<td>0 ETH</td>
										<td>14</td>
									...
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xa26e80e7dea86279c6d778d702cc413e6cffa777" data-bs-toggle="tooltip" data-bs-title="0xa26e80e7dea86279c6d778d702cc413e6cffa777">0xa26e80...6CFfA777</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xa26e80e7Dea86279c6d778D702Cc413E6CFfA777" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xa26_20&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xa26_20" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Staking Proxy V3</td>
										<td>0 ETH</td>
										<td>35,293</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x3517b88c19508c08650616019062b898ab65ed29" data-bs-toggle="tooltip" data-bs-title="0x3517b88c19508c08650616019062b898ab65ed29">0x3517B8...Ab65ED29</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x3517B88c19508c08650616019062b898Ab65ED29" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x351_21&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x351_21" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Static Call Proxy V3</td>
										<td>0 ETH</td>
										<td>1</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x926a74c5c36adf004c87399e65f75628b0f98d2c" data-bs-toggle="tooltip" data-bs-title="0x926a74c5c36adf004c87399e65f75628b0f98d2c">0x926a74...b0f98D2C</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x926a74c5C36adf004C87399e65f75628b0f98D2C" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x926_22&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x926_22" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Token Registry</td>
										<td>0 ETH</td>
										<td>159</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0x8da0d80f5007ef1e431dd2127178d224e32c2ef4" data-bs-toggle="tooltip" data-bs-title="0x8da0d80f5007ef1e431dd2127178d224e32c2ef4">0x8da0D8...E32C2eF4</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0x8da0D80f5007ef1e431DD2127178d224E32C2eF4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0x8da_23&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0x8da_23" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Token Transfer Proxy</td>
										<td>0 ETH</td>
										<td>18</td>
									</tr>
									<tr class="even">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xa6baaed2053058a3c8f11e0c7a9716304454b09e" data-bs-toggle="tooltip" data-bs-title="0xa6baaed2053058a3c8f11e0c7a9716304454b09e">0xa6BAae...4454b09e</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xa6BAaeD2053058a3C8F11e0c7A9716304454b09e" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xa6b_24&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xa6b_24" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: Uniswap Bridge</td>
										<td>0 ETH</td>
										<td>2</td>
									</tr>
									<tr class="odd">
										<td class="align-items-center">
											<span class="d-flex align-items-center"><span class="d-flex align-items-center" style="white-space:nowrap;"><i data-bs-toggle="tooltip" title="Contract" class="far fa-file-alt text-secondary me-1"></i><a class="me-1" href="/address/0xe41d2489571d322189246dafa5ebde1f4699f498" data-bs-toggle="tooltip" data-bs-title="0xe41d2489571d322189246dafa5ebde1f4699f498">0xE41d24...4699F498</a> <a class="js-clipboard link-secondary " href="javascript:;" data-clipboard-text="0xE41d2489571d322189246DaFA5ebDe1F4699F498" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Copy Address" data-hs-clipboard-options="{ &quot;type&quot;: &quot;tooltip&quot;, &quot;successText&quot;: &quot;Copied!&quot;, &quot;classChangeTarget&quot;: &quot;#linkIcon_0xe41_25&quot;, &quot;defaultClass&quot;: &quot;fa-copy&quot;, &quot;successClass&quot;: &quot;fa-check&quot; }"><i id="linkIcon_0xe41_25" class="far fa-copy fa-fw "></i> </a></span></span>
										</td>
										<td>0x: ZRX Token</td>
										<td>0 ETH</td>
										<td>1,913,040</td>
								...
								<tfoot id="sublabel-1">
									<tr class="table-active">
										<th class="border-top border-bottom-0"></th>
										<th class="border-top border-bottom-0">Sum of 26 Accounts</th>
										<th class="border-top border-bottom-0">0.29358897 Ether</th>
										<th class="border-top border-bottom-0">7,119,921</th>
									</tr>
								</tfoot>
							</table>
						</div>
					</div>
					<div class="tab-pane fade " id="subcattab-3-0" role="tabpanel" aria-labelledby="3-0-tab">
						<div class="table-responsive " id="paywall_mask_table-subcatid-3-0">
							<table class="table table-hover table-align-middle mb-0" style="width:100%"
								id="table-subcatid-3-0">
								<thead class="align-middle text-nowrap">
									<tr>
										<th scope="col" width="370">Address</th>
										<th class="remove-icon" scope="col">Name Tag</th>
								...
								<tbody></tbody>
								<tfoot id="sublabel-3-0" class="hideFooter">
									<tr class="table-active">
										<th class="border-top border-bottom-0"></th>
										<th class="border-top border-bottom-0">Sum of 23 Accounts</th>
										<th class="border-top border-bottom-0">4.01237963 Ether</th>
										<th class="border-top border-bottom-0">2,191,575</th>
									</tr>
								</tfoot>
							</table>
						</div>
					</div>
					<div class="tab-pane fade " id="subcattab-2" role="tabpanel" aria-labelledby="2-tab">
						<div class="table-responsive " id="paywall_mask_table-subcatid-2">
							<table class="table table-hover table-align-middle mb-0" style="width:100%"
								id="table-subcatid-2">
								<thead class="align-middle text-nowrap">
									<tr>
								...
								<tbody></tbody>
								<tfoot id="sublabel-2" class="hideFooter">
									<tr class="table-active">
										<th class="border-top border-bottom-0"></th>
										<th class="border-top border-bottom-0">Sum of 9 Accounts</th>
										<th class="border-top border-bottom-0">0.02 Ether</th>
										<th class="border-top border-bottom-0">991,719</th>
									</tr>
								</tfoot>
							</table>
						</div>
				...
				<form method="post" action="./0x-protocol" id="frmTblFooter">
					<div class="aspNetHidden">
						<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="nkyE+rWtfWcdO9CP0CldYhQt7qrCBu6CQqmYg6RcsE20Xj2BXWv9VrmrmEGew6KQdK/6mKgHlIiLmWTSHZ9mI1ZT9VKzMNtt9wej0lkaC7U=" />
</div>
						<div class="aspNetHidden">
...
$('#spinwheel').remove();//]]>
			...
			<div id="ContentPlaceHolder1_divFootNote" class="mt-4">
				<p class="d-flex align-items-baseline fs-sm text-muted gap-1 mb-3">
					<i class="far fa-lightbulb-on"></i><span>Note : Labels source attribution required if used externally</span>
				</p>
			</div>

		</section>

		<input type="hidden" id="hdnLabelFilter" value="0x-protocol">
		<script>
			var mydt = []
        ...
        var currentTab = '1'
            var refreshToDefaultDictionary = {'table-subcatid-1': false,'table-subcatid-3-0': true,'table-subcatid-2': true};
        ...
        mydt['table-subcatid-1'] = $('#table-subcatid-1').DataTable(config);mydt['table-subcatid-3-0'] = $('#table-subcatid-3-0').DataTable(config);mydt['table-subcatid-2'] = $('#table-subcatid-2').DataTable(config);
    });
		</script>
	</main>
...
Understand, Copy Address
		...
		<div class="container-xxl">
			<div class="d-flex justify-content-between align-items-baseline py-6">
				...
				<div class="d-flex gap-2">
					<a class="btn btn-sm btn-secondary content-center rounded-circle" style="width: 2rem; height: 2rem;"
						href="https://twitter.com/etherscan" rel="nofollow noopener" target="_blank"
						data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Twitter">
						<i class="fab fa-twitter"></i>
					</a>
					<a class="btn btn-sm btn-secondary content-center rounded-circle" style="width: 2rem; height: 2rem;"
						href="https://medium.com/etherscan-blog" rel="nofollow noopener" target="_blank"
						data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Medium">
						<i class="fab fa-medium"></i>
					</a>
					<a class="btn btn-sm btn-secondary content-center rounded-circle" style="width: 2rem; height: 2rem;"
						href="https://www.facebook.com/etherscan/" rel="nofollow noopener" target="_blank"
						data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Facebook">
						<i class="fab fa-facebook"></i>
					</a>
					<a class="btn btn-sm btn-secondary content-center rounded-circle" style="width: 2rem; height: 2rem;"
						href="https://www.reddit.com/r/etherscan/" rel="nofollow noopener" target="_blank"
						data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Reddit">
			...
			<div class="row justify-content-md-between py-8 py-lg-10">
				<div class="col-lg-4 pe-xl-16 mb-4 mb-lg-0">
					...
					<p class="fs-sm">Etherscan is a Block Explorer and Analytics Platform for Ethereum, a decentralized
						...
						<ul class="list-unstyled list-sm-space fs-sm mb-0">
							...
							<li>
								<a class="link-dark" href="/careers">
									...
									<span class="bg-primary text-white small fw-medium text-nowrap rounded-pill p-1 px-2">We're Hiring!</span>
								</a>
							</li>
							<li><a class="link-dark" href="/terms">Terms</a> & <a class="link-dark"
									href="/privacyPolicy">Privacy</a></li>
					...
					<div class="col-6 col-md-4 col-lg mb-10 mb-md-0">
						...
						<ul class="list-unstyled list-sm-space fs-sm mb-0">
							<li><a class="link-dark" href="https://docs.etherscan.io/" target="_blank">API
									Documentation</a></li>
							<li><a class="link-dark" href="https://info.etherscan.com/">Knowledge Base</a></li>
							<li><a class="link-dark" href="https://etherscan.freshstatus.io/" rel="nofollow noopener"
					...
					<div class="col-6 col-md-4 col-lg">
						...
						<ul class="list-unstyled list-sm-space fs-sm mb-0">
							...
							<li><a class="link-dark" href="https://blockscan.com" target="_blank">Blockscan
									<i class="far fa-arrow-up-right-from-square text-muted ms-1"></i></a></li>
							<li><a class="link-dark" href="https://chat.blockscan.com/start" target="_blank">Blockscan
									Chat <i class="far fa-arrow-up-right-from-square text-muted ms-1"></i></a></li>
						</ul>
						...
						<div class="col-md text-md-end">
							<p class="mb-0">
								Donations: <a class="me-1"
									href="/address/0x71c7656ec7ab88b098defb751b7401b5f6d8976f"><span id="spanDonateAddress" runat="server">0x71c765...d8976f</span></a>
		...
		<div class="fixed-bottom text-center" id="divcookie" style="display: none;">
			<div class="alert alert-light fade show border shadow-sm d-inline-flex flex-wrap flex-sm-nowrap align-items-sm-center text-start gap-3 mx-3"
				...
				<p class="text-dark mb-0">
					<i class="far fa-cookie-bite text-muted"></i> This website <a href="/terms#cookiestatement"
						target="_blank">uses cookies to improve your experience</a>. By continuing to use this website,
					you agree to its <a href="/terms" target="_blank">Terms</a> and <a href="/privacyPolicy"
	...
	<script src="/assets/vendor/jquery-ui/jquery-ui.min.js?v=24.1.2.1"></script>
	<script src="/assets/vendor/jquery-migrate/dist/jquery-migrate.min.js?v=24.1.2.1"></script>
	<script src="/assets/vendor/bootstrap/bootstrap.bundle.min.js?v=24.1.2.1"></script>

	<script src="/assets/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js?v=24.1.2.1"></script>
	<script src="/assets/vendor/clipboard/dist/clipboard.min.js?v=24.1.2.1"></script>

	<script src="/assets/js/hs.core.js?v=24.1.2.1"></script>
	<script src="/assets/js/components/hs.cubeportfolio.js?v=24.1.2.1"></script>
	<script src="/assets/js/custom/combine-js-bottom2.js?v=24.1.2.1"></script>
	<script src="/assets/vendor/autocomplete/dist/js/autocomplete.min.js?v=24.1.2.1"></script>
	<script src="/assets/js/custom/ether-search.js?v=24.1.2.1"></script>

	<script src="/assets/js/app.min.js?v=24.1.2.1"></script>
	...
	<script type="text/javascript">
		var sid = 'c948aff559961e85bd21404e48cfaf35';
	...
	<script src="/assets/js/custom/web3.min.js?v=24.1.2.1"></script>
	<script type="text/javascript">
		var web3ojb;
        var isTestnet = 'false';
        var chain = 'Mainnet'
...
# Extract data from similar <a> tags
similar_a_tags = [a_tag for a_tag in soup.find_all('a') if a_tag.get('href') and a_tag['href'].startswith('/accounts/label')]
similar_extracted_data = []
for a_tag in similar_a_tags:
    match = re.search(r'\b\d+\b', a_tag.get_text(strip=True))
    if match:
        text_integer = int(match.group())
        href_parts = a_tag['href'].split('/')
    
        tag_data = {
            'label_id': text_integer, 
            'accounts': text_integer,  
        }
    
        similar_extracted_data.append(tag_data)

# Extract data from <a> tags with id="tab-xx"
...
h1_element = soup.find('h1', class_='h5 mb-0')
if h1_element:
    name_text = ' '.join(h1_element.stripped_strings)
    combined_extracted_data['name'] = name_text
    filtered_labels = ["Uniswap", "Beacon Depositor"]
    filtered_data = [tag_data for tag_data in similar_extracted_data if tag_data['label_id'] in filtered_labels]

    if filtered_data:
        for label_data in filtered_data:
            label_name = "Others" if label_data['label_id'] == 1 else "Legacy"  
            combined_extracted_data[label_name] = label_data['accounts']

if similar_extracted_data:
    combined_extracted_data.update(similar_extracted_data[0])
print(f"Filtered Data: {filtered_data}")
print(f"Combined Extracted Data: {combined_extracted_data}")

for a_tag in all_a_tags:
    name = a_tag.get('name')
    text = a_tag.get_text(strip=True)
    if name == 'Main':
        numeric_part = re.search(r'\b\d+\b', text)
        combined_extracted_data['Main'] = int(numeric_part.group()) if numeric_part else None
    elif name == 'Others':
        numeric_part = re.search(r'\b\d+\b', text)
        combined_extracted_data['Others'] = int(numeric_part.group()) if numeric_part else None
    elif name == 'Legacy':
        numeric_part = re.search(r'\b\d+\b', text)
        combined_extracted_data['Legacy'] = int(numeric_part.group()) if numeric_part else None
print(f"Final Combined Extracted Data: {combined_extracted_data}")

# Extract data from the table
table_data = []
table_rows = soup.select('#table-subcatid-1 tbody tr')
...
combined_extracted_data['subhead'] = table_data
combined_extracted_data.pop('MAIN', None)

table_data.append({
    'Address': str("0xba7f8b5fb1b19c1211c5d49550fcd149177a5eaf"),
    'Name_tag': "0x: ZRX Vault V3",
})
if 'subhead' in combined_extracted_data:
    if combined_extracted_data['subhead'] is None:
        combined_extracted_data['subhead'] = table_data
    else:
        combined_extracted_data['subhead'].extend(table_data)
else:
    combined_extracted_data['subhead'] = table_data
if 'subhead' in combined_extracted_data:
    subhead_length = len(combined_extracted_data['subhead'])
    print(f"Length of 'subhead': {subhead_length}")

print(f"Table Data: {table_data}")
print(f"Final Combined Extracted Data: {combined_extracted_data}")
json_file_path = '0x-Protocol.json'
with open(json_file_path, 'w', encoding='utf-8') as json_file:
    json.dump(combined_extracted_data, json_file, ensure_ascii=False, indent=4,default=str, separators=(',', ': '))
